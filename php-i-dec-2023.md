...
* At this point you'll see two prompts: one to update, one to upgrade. Be sure to decline the "Ubuntu Upgrade" option!
...
Please note that "8.0" is the old version, and "8.2" is the new version. 
You may have to change these two values as more recent versions become available (e.g. "8.3").
```
